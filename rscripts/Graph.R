...
# You also need to set the column with that name to null where indicated below
...
# If you brought in a period that was not the prediction (a training period): 
dfFULL$TEST_2020.05.21=NULL
dfFULL$TEST_2020.05.29=NULL
dfFULL$TEST_2020.06.08=NULL
dfFULL$TEST_2020.06.22=NULL
dfFULL$TEST_2020.10.08=NULL
dfFULL$TEST_2020.11.01=NULL
dfFULL$TEST_2020.09.27=NULL
