...
public class PythonPathNotSpecifiedException extends Exception{

	private static final long serialVersionUID = 1L;

	public PythonPathNotSpecifiedException() {
		super("Python Path Environment Variable 'GDELT_GAS_PSCRIPT_PATH' not set");
	}
}