 ...
 * }
 */
package gdelt.query.domains;

import gdelt.query.domains.components.DoubleQueryDomain;

public class ActionLongitude extends DoubleQueryDomain{

	public ActionLongitude(INIT_METHOD initMethod) {
		super("ActionLongitude", -180, 180, initMethod);
	}
