 ...
 */
public class Scorer_NRMSE_STD extends Scorer_RMSE{

	public Scorer_NRMSE_STD() {
		super();
	}
	
	public Scorer_NRMSE_STD(TimeSeries dataSet, int tMin, int tMax, LocalDateTime ... dateTimes) {
		super(dataSet, tMin, tMax, dateTimes);
	}
	
	@Override
	protected double normalize(double valToNormalize, double[] testvals) {
		return valToNormalize/stdDev(testvals);
	}
	
	public String getType() {
		return "Scorer_NRMSE_STD";
	}
}
