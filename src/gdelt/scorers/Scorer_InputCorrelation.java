...
/**
 * A scorer class that just compares the input
 * as a correlation. 
 */
public class Scorer_InputCorrelation extends Scorer {
	
	public Scorer_InputCorrelation() {
		super();
	}
	
	public Scorer_InputCorrelation(TimeSeries dataSet, int tMin, int tMax, LocalDateTime ... dateTimes) {
...
//		PearsonsCorrelation pc = new PearsonsCorrelation();
	...
	public String getType() {
		return "Scorer_InputCorrelation";
	}
}
