...
/**
 * A 'Not-A-Number' version of a SmartScore,
 * indicating that some invalid calculation was made to
 * arrive at this score.
 */
public class ScoreNaN extends SmartScore {
	...
	public COMPARISON isBetter(SmartScore other) {
		return Double.isNaN(other.value) ? COMPARISON.EQUIVALENT : COMPARISON.WORSE;
	}
