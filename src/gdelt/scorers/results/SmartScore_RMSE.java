...
/**
 * A root mean squared error version of the
 * smart score.
 */
public class SmartScore_RMSE extends SmartScore {

	public SmartScore_RMSE(double val) {
		super(val);
	}
